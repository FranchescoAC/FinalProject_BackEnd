...
const viewRoutes = require('../ViewTicket/src/routes/viewRoutes');
const db = require('../ViewTicket/src/config/db'); // Importa el módulo db
const app = express();
...
// Rutas
app.use('/api/tickets', viewRoutes); // Prefijo para las rutas de tickets
